...
angular.module('ngProgress.provider', ['ngProgress.directive'])
    .provider('ngProgress', function () {
        ...
        this.$get = ['$document',
            ...
            return {
                // Starts the animation and adds between 0 - 5 percent to
				// loading
                // each 400 milliseconds. Should always be finished with
...
//                    return height;
//                },
//                // Sets the color of the progressbar and it's shadow. Use any
//				// valid HTML
//                // color
...
//                },
                ...
                // Returns on how many percent the progressbar is at. Should'nt
				// be needed
                status: function () {
                    return count;
                },
                ...
                // Set's the progressbar percentage. Use a number between 0 -
				// 100.
                ...
                // Resets the progressbar to percetage 0 and therefore will be
				// hided after
                // it's rollbacked
                reset: function () {
                    clearInterval(intervalCounterId);
...
angular.module('ngProgress.directive', [])
    .directive('ngProgress', ["$window", "$rootScope", function ($window, $rootScope) {
        var directiveObj = {
            ...
            template: '<div class="progress progress-striped active"> <div class="bar"></div> </div>'
        };
        return directiveObj;
    }]);
